...
class MatchList : AppCompatActivity(), FlatAdapter.OnItemClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        matchList = mutableListOf(
                Flat("Minden", "", "gehirnstraße", "", "", "", "", "", "", "", "", ""),
                Flat("Lübbecke", "test", "1.0straße", "", "", "", "", "", "", "", "", ""),
                Flat("Espelkamp", "test", "Straße", "", "", "", "", "", "", "", "", ""),
                Flat("Stemwede", "test", "Straße", "", "", "", "", "", "", "", "", ""),
                Flat("Hille", "test", "Straße", "", "", "", "", "", "", "", "", ""),
                Flat("Bielefeld", "test", "Straße", "", "", "", "", "", "", "", "", ""),
                Flat("Hannover", "test", "Straße", "", "", "", "", "", "", "", "", ""),
                Flat("Köln", "test", "Straße", "", "", "", "", "", "", "", "", ""),
                Flat("Winterfell", "test", "Straße", "", "", "", "", "", "", "", "", ""),
                Flat("Ba Sing Se", "test", "test", "", "", "", "", "", "", "", "", "")
        )
